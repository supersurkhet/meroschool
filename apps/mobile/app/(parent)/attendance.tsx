...
export default function ParentAttendanceScreen() {
	...
	const summary = useMemo(() => {
		if (monthlySummary) {
			...
			const percentage =
				monthlySummary.percentage ?? (schoolDays > 0 ? Math.round((present / schoolDays) * 100) : 0)
	...
	const isLoading =
		studentId !== undefined && (attendanceRange === undefined || monthlySummary === undefined)
								...
								>
									{summary.schoolDays > 0 && (
										<>
											<View
												style={{
													width: `${(summary.present / summary.schoolDays) * 100}%`,
													backgroundColor: colors.success,
												}}
											/>
											<View
												style={{
													width: `${(summary.late / summary.schoolDays) * 100}%`,
													backgroundColor: colors.warning,
												}}
											/>
											<View
												style={{
													width: `${(summary.absent / summary.schoolDays) * 100}%`,
													backgroundColor: colors.danger,
												}}
											/>
										</>
