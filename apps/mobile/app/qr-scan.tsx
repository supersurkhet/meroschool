...
export default function QRScanScreen() {
	...
	const errorMessages: Record<ErrorType, { title: string; message: string }> = {
		...
		wrong_section: {
			title: 'Wrong Section',
			message: `This QR is for another section. You are in ${user?.sectionId ?? 'your section'}.`,
		},
		already_marked: {
		...
		network: {
			...
			message: 'Could not mark attendance. Check your internet connection.',
		},
	}
	...
	if (scanState === 'success') {
		return (
			...
			>
				...
				<Text
					style={{ fontSize: 15, color: colors.textSecondary, marginTop: 8, textAlign: 'center' }}
				>
